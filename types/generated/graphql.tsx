...
export type Mutation_Root = {
  ...
  /** delete data from the table: "profiles_users" */
  delete_profiles_users?: Maybe<Profiles_Users_Mutation_Response>;
  /** delete single row from the table: "profiles_users" */
  delete_profiles_users_by_pk?: Maybe<Profiles_Users>;
  ...
  /** insert data into the table: "profiles_users" */
  insert_profiles_users?: Maybe<Profiles_Users_Mutation_Response>;
  /** insert a single row into the table: "profiles_users" */
  insert_profiles_users_one?: Maybe<Profiles_Users>;
  ...
  /** update data of the table: "profiles_users" */
  update_profiles_users?: Maybe<Profiles_Users_Mutation_Response>;
  /** update single row of the table: "profiles_users" */
  update_profiles_users_by_pk?: Maybe<Profiles_Users>;
  /** update multiples rows of table: "profiles_users" */
  update_profiles_users_many?: Maybe<Array<Maybe<Profiles_Users_Mutation_Response>>>;
...
/** mutation root */
export type Mutation_RootDelete_Profiles_UsersArgs = {
  where: Profiles_Users_Bool_Exp;
};


/** mutation root */
export type Mutation_RootDelete_Profiles_Users_By_PkArgs = {
  id: Scalars['uuid'];
};
...
/** mutation root */
export type Mutation_RootInsert_Profiles_UsersArgs = {
  objects: Array<Profiles_Users_Insert_Input>;
  on_conflict?: InputMaybe<Profiles_Users_On_Conflict>;
};


/** mutation root */
export type Mutation_RootInsert_Profiles_Users_OneArgs = {
  object: Profiles_Users_Insert_Input;
  on_conflict?: InputMaybe<Profiles_Users_On_Conflict>;
};
...
/** mutation root */
export type Mutation_RootUpdate_Profiles_UsersArgs = {
  _set?: InputMaybe<Profiles_Users_Set_Input>;
  where: Profiles_Users_Bool_Exp;
};


/** mutation root */
export type Mutation_RootUpdate_Profiles_Users_By_PkArgs = {
  _set?: InputMaybe<Profiles_Users_Set_Input>;
  pk_columns: Profiles_Users_Pk_Columns_Input;
};


/** mutation root */
export type Mutation_RootUpdate_Profiles_Users_ManyArgs = {
  updates: Array<Profiles_Users_Updates>;
};
...
export type Profiles = {
  ...
  /** An array relationship */
  profiles_users: Array<Profiles_Users>;
  /** An aggregate relationship */
  profiles_users_aggregate: Profiles_Users_Aggregate;
...
/** columns and relationships of "profiles" */
export type ProfilesProfiles_UsersArgs = {
  distinct_on?: InputMaybe<Array<Profiles_Users_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Profiles_Users_Order_By>>;
  where?: InputMaybe<Profiles_Users_Bool_Exp>;
};


/** columns and relationships of "profiles" */
export type ProfilesProfiles_Users_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Profiles_Users_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Profiles_Users_Order_By>>;
...
export type Profiles_Bool_Exp = {
  ...
  profiles_users?: InputMaybe<Profiles_Users_Bool_Exp>;
...
export type Profiles_Insert_Input = {
  ...
  profiles_users?: InputMaybe<Profiles_Users_Arr_Rel_Insert_Input>;
...
export type Profiles_Order_By = {
  ...
  profiles_users_aggregate?: InputMaybe<Profiles_Users_Aggregate_Order_By>;
...
/** columns and relationships of "profiles_users" */
export type Profiles_Users = {
  __typename?: 'profiles_users';
  id: Scalars['uuid'];
  /** An object relationship */
  profile: Profiles;
...
/** aggregated selection of "profiles_users" */
export type Profiles_Users_Aggregate = {
  __typename?: 'profiles_users_aggregate';
  aggregate?: Maybe<Profiles_Users_Aggregate_Fields>;
  nodes: Array<Profiles_Users>;
};

/** aggregate fields of "profiles_users" */
export type Profiles_Users_Aggregate_Fields = {
  __typename?: 'profiles_users_aggregate_fields';
  count: Scalars['Int'];
  max?: Maybe<Profiles_Users_Max_Fields>;
  min?: Maybe<Profiles_Users_Min_Fields>;
};


/** aggregate fields of "profiles_users" */
export type Profiles_Users_Aggregate_FieldsCountArgs = {
  columns?: InputMaybe<Array<Profiles_Users_Select_Column>>;
  distinct?: InputMaybe<Scalars['Boolean']>;
};

/** order by aggregate values of table "profiles_users" */
export type Profiles_Users_Aggregate_Order_By = {
  count?: InputMaybe<Order_By>;
  max?: InputMaybe<Profiles_Users_Max_Order_By>;
  min?: InputMaybe<Profiles_Users_Min_Order_By>;
};

/** input type for inserting array relation for remote table "profiles_users" */
export type Profiles_Users_Arr_Rel_Insert_Input = {
  data: Array<Profiles_Users_Insert_Input>;
  /** upsert condition */
  on_conflict?: InputMaybe<Profiles_Users_On_Conflict>;
};

/** Boolean expression to filter rows from the table "profiles_users". All fields are combined with a logical 'AND'. */
export type Profiles_Users_Bool_Exp = {
  _and?: InputMaybe<Array<Profiles_Users_Bool_Exp>>;
  _not?: InputMaybe<Profiles_Users_Bool_Exp>;
  _or?: InputMaybe<Array<Profiles_Users_Bool_Exp>>;
  id?: InputMaybe<Uuid_Comparison_Exp>;
...
/** unique or primary key constraints on table "profiles_users" */
export enum Profiles_Users_Constraint {
  /** unique or primary key constraint on columns "id" */
  ProfilesUsersPkey = 'profiles_users_pkey'
}

/** input type for inserting data into table "profiles_users" */
export type Profiles_Users_Insert_Input = {
  id?: InputMaybe<Scalars['uuid']>;
...
/** aggregate max on columns */
export type Profiles_Users_Max_Fields = {
  __typename?: 'profiles_users_max_fields';
  id?: Maybe<Scalars['uuid']>;
  profile_id?: Maybe<Scalars['uuid']>;
  user_id?: Maybe<Scalars['uuid']>;
};

/** order by max() on columns of table "profiles_users" */
export type Profiles_Users_Max_Order_By = {
  id?: InputMaybe<Order_By>;
...
/** aggregate min on columns */
export type Profiles_Users_Min_Fields = {
  __typename?: 'profiles_users_min_fields';
  id?: Maybe<Scalars['uuid']>;
  profile_id?: Maybe<Scalars['uuid']>;
  user_id?: Maybe<Scalars['uuid']>;
};

/** order by min() on columns of table "profiles_users" */
export type Profiles_Users_Min_Order_By = {
  id?: InputMaybe<Order_By>;
  profile_id?: InputMaybe<Order_By>;
  user_id?: InputMaybe<Order_By>;
};

/** response of any mutation on the table "profiles_users" */
export type Profiles_Users_Mutation_Response = {
  __typename?: 'profiles_users_mutation_response';
  /** number of rows affected by the mutation */
  affected_rows: Scalars['Int'];
  /** data from the rows affected by the mutation */
  returning: Array<Profiles_Users>;
};

/** on_conflict condition type for table "profiles_users" */
export type Profiles_Users_On_Conflict = {
  constraint: Profiles_Users_Constraint;
  update_columns?: Array<Profiles_Users_Update_Column>;
  where?: InputMaybe<Profiles_Users_Bool_Exp>;
};

/** Ordering options when selecting data from "profiles_users". */
export type Profiles_Users_Order_By = {
  id?: InputMaybe<Order_By>;
...
/** primary key columns input for table: profiles_users */
export type Profiles_Users_Pk_Columns_Input = {
  id: Scalars['uuid'];
};

/** select columns of table "profiles_users" */
export enum Profiles_Users_Select_Column {
  /** column name */
  Id = 'id',
  /** column name */
...
/** input type for updating data in table "profiles_users" */
export type Profiles_Users_Set_Input = {
  id?: InputMaybe<Scalars['uuid']>;
  profile_id?: InputMaybe<Scalars['uuid']>;
  user_id?: InputMaybe<Scalars['uuid']>;
};

/** update columns of table "profiles_users" */
export enum Profiles_Users_Update_Column {
  /** column name */
  Id = 'id',
  /** column name */
  ProfileId = 'profile_id',
...
export type Profiles_Users_Updates = {
  /** sets the columns of the filtered rows to the given values */
  _set?: InputMaybe<Profiles_Users_Set_Input>;
  where: Profiles_Users_Bool_Exp;
};
...
export type Query_Root = {
  ...
  /** An aggregate relationship */
  profiles_users_aggregate: Profiles_Users_Aggregate;
  /** fetch data from the table: "profiles_users" using primary key columns */
  profiles_users_by_pk?: Maybe<Profiles_Users>;
  /** An array relationship */
  users: Array<Users>;
  /** An aggregate relationship */
  users_aggregate: Users_Aggregate;
...
export type Query_RootProfiles_UsersArgs = {
  distinct_on?: InputMaybe<Array<Profiles_Users_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Profiles_Users_Order_By>>;
...
export type Query_RootProfiles_Users_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Profiles_Users_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Profiles_Users_Order_By>>;
...
export type Query_RootProfiles_Users_By_PkArgs = {
  id: Scalars['uuid'];
};
...
export type Subscription_RootProfiles_UsersArgs = {
  distinct_on?: InputMaybe<Array<Profiles_Users_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Profiles_Users_Order_By>>;
...
export type Subscription_RootProfiles_Users_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Profiles_Users_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Profiles_Users_Order_By>>;
...
export type Subscription_RootProfiles_Users_By_PkArgs = {
  id: Scalars['uuid'];
};
...
/** columns and relationships of "users" */
export type UsersProfiles_UsersArgs = {
  distinct_on?: InputMaybe<Array<Profiles_Users_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Profiles_Users_Order_By>>;
...
/** columns and relationships of "users" */
export type UsersProfiles_Users_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Profiles_Users_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Profiles_Users_Order_By>>;
